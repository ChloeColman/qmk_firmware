...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ortho_4x10(
    ...
    KC_ESCAPE, KC_LGUI, KC_NO, LCTL_T(KC_TAB), LT(2, KC_SPACE), MO(1), LSFT_T(KC_BACKSPACE), KC_NO,   KC_LALT, KC_ENTER),
  [1] = LAYOUT_ortho_4x10(
    KC_1,      KC_2,     KC_3,     KC_4,        KC_5,        KC_6,    KC_7,    KC_8,      KC_9,     KC_0,
    KC_GRAVE,  KC_MINUS, KC_EQUAL, KC_LBRC, KC_RBRC, KC_LEFT, KC_DOWN, KC_UP,     KC_RIGHT, KC_QUOTE,
  ...
  [2] = LAYOUT_ortho_4x10(
    ...
    LSFT(KC_GRAVE), LSFT(KC_MINUS), LSFT(KC_EQUAL), LSFT(KC_LBRC), LSFT(KC_RBRC), KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, LSFT(KC_QUOTE),
  ...
  [3] = LAYOUT_ortho_4x10(
    ...
    KC_NO, QK_MAGIC_SWAP_LCTL_LGUI, KC_NO, QK_MAGIC_SWAP_LCTL_LGUI, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO),
  [4] = LAYOUT_ortho_4x10(
